...
export default class TetrisRender {
   constructor(container, tetris) {
      ...
      graphics.drawRect(0, 0, this.areaW, this.areaH);
      graphics.endFill();
   ...
   // drawCell(x, y, idx, size, darkness) {
   ...
   //    this.ctx.restore();
   // }
   // drawTetrisArea(pos, tetris, host) {
